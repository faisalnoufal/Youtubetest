...
function getPlaylistData(playlistID, video_list, page_token) {
  ...
  var apiKey = "AIzaSyBhCW-Vsv2Vr9cqi_p_2OzYmcAHrwr8rdk"; // Don't steal this! There is a limit set of 150 hits per day.
  var theUrl =
    "https://www.googleapis.com/youtube/v3/playlistItems?part=snippet,contentDetails,status" +
    "&maxResults=" +
    1000 + //Can be anything from 1-50
    "&playlistId=" +
    playlistID +
    "&key=" +
    apiKey;
...
// Reverse the data array in place
    data.reverse();
